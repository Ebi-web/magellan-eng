...
<body>
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
        ...
        <div id="photo" class="erase">
            <br>
            <strong>同時に3枚までアップロードできます。(拡張子は.jpg,.jpeg,.pngのみ可能。1画像ファイルにつき5MBまで)</strong>
                ...
                foreach ($role as $roles) : ?>
                    ...
                    <div class="input-group">
                        <div class="custom-file">
                            ...
                            <label class="custom-file-label" for="inputGroupFile04">音声ファイル貼り付け(mp3形式のみ可能。1音声ファイルにつき5MBまで)</label>
                        </div>
                        <div class="input-group-append">
