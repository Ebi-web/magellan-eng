        ...
        <div class="toggle-inner">
          ...
          <section id="1">
            ...
            <p>Magellanは開発者が埼玉県の大宮高校英語部に在籍していた頃の体験を基に作られております。<br>
              ...
              現在(2020年12月)黎明期にあるMagellanにとってユーザーである全国のEnglish Debatersの皆様からのフィードバック・ご感想はとても貴重なものです。<br>
          ...
          <section id="2">
            ...
            <ul>
              ...
              <li><span class="red">試合を登録する方法その2(特定の学校が出た試合を登録する場合におすすめ)</span><br>①画面左のメニューから学校別フロー管理をクリック<br>
                ②学校名・大会を選択(ない場合は登録)<br> ③画面右上の試合登録ボタンをクリックして必要事項を入力(登録ボタンは1度だけ押してください)<br>
          ...
          <section id="4">
            ...
            <ul>
              ...
              <hr>
              <li><span class="red">フローシートを削除する方法</span> <br>①削除するフローシートの「修正画面」に移動<br>
                ②画面右上の「このフローを破棄」ボタンをクリック(確認メッセージが表示されます)<br>
