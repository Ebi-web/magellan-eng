    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                ...
                <div align="center">
                    <h2><?= h($_SESSION['username']) ?>の相手校別一覧</h2>
                    <h3>相手校別のフロー登録・管理はここから行えます</h3>
                </div>
                <div class="container">
                    <div class="row">
                        <?php
                            ...
                            <div class="col-md-4">
                                <div class="card mb-4 shadow-sm">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text"><?= h($others['school_name']) ?></p>
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="btn-group">
                                                <!-- <button type="button" class="btn btn-sm btn-outline-secondary">View</button> -->
                                                <!-- <button type="button" class="btn btn-sm btn-outline-secondary">見る</button> -->
                                                <!-- <button type="button" class="btn btn-sm btn-outline-secondary">Edit</button> -->
                                                <button type="button" class="btn btn-sm btn-outline-secondary" onclick="location.href='./newschool_matches.php?id=<?= $others['id'] ?>&name=<?= $others['school_name'] ?>'">編集</button>
                                            </div>
