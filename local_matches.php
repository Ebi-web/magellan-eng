...
try {
    ...
    $stmt0->execute(array($_SESSION['abst_id'], $_SESSION['id'], $_SESSION['id']));
        ...
        <div class="row">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom"'>
                    <h1 class="h2"><?= $_SESSION['tName'] ?>(<?= $_SESSION['name'] ?>のみ)</h1>
                    <div nowrap>
                        <button style="border: dashed 2px; margin-right:4px;" onclick="deleteCheck()" class="btn btn-light"><img src="assets/img/ごみ箱のフリーアイコン.png"></button><button type="button" class="btn btn-success buttonleft" onclick="location.href=' ./local_match_insert_input.php'"><?= $_SESSION['name'] ?>vs.自校の試合登録 </button> <button type="button" class="btn btn-info buttonright" onclick="location.href='./local_match_insert_jikouigai.php'"><?= $_SESSION['name'] ?>vs.他校の試合登録</button>
                </div>
        </div>
    </div>
    <div class="tab_wrap">
